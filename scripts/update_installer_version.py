...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=BlockMax Demo Installer\n"
      else:
        line="OutputBaseFilename=BlockMax Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the BlockMax Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the BlockMax installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=BlockMax Demo installer\n"
     else:
       line="SetupWindowTitle=BlockMax installer\n"
