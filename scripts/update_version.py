...
def main():
  ...
  plistpath = scriptpath + "/resources/BlockMax-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BlockMax-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BlockMax-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BlockMax-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BlockMax-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BlockMax.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BlockMax.iss",inplace=1):
